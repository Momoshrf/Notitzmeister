...
public class HelperUtils {
    ...
    public static String PREFERENCE_FONT_SIZE = "fontSize"; // New constant for font size preference
    ...
    // Method to set font size for a TextView
    public static void setFontSize(TextView textView, int sizeInSp) {
